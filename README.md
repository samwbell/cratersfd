...
6) If you want the large files for the calculations in the calc folder, download the contents of calc/figs and calc/saved from [the Zenodo record](https://zenodo.org/records/13917307).
