...
_lower_PPFit = read_PPFit('lower_PPFit')
_upper_PPFit = read_PPFit('upper_PPFit')
_lower_PPFit_linear = read_PPFit('lower_PPFit_linear')
_upper_PPFit_linear = read_PPFit('upper_PPFit_linear')
_val_PPFit_auto_log = read_PPFit('val_PPFit_auto_log')
_lower_PPFit_auto_log = read_PPFit('lower_PPFit_auto_log')
_upper_PPFit_auto_log = read_PPFit('upper_PPFit_auto_log')
_val_PPFit_log_linear = read_PPFit('val_PPFit_log_linear')
